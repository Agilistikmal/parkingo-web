            ...
            <div class="space-y-2" v-auto-animate>
                <label for="address">
                    ...
                    <textarea id="address" name="address" type="text" placeholder="Jl. ABC No. 123, Yogyakarta"
                        ref="autoComplete" class="w-full"></textarea>
                ...
                <label for="name" v-if="selectedAddress.name">
                    ...
                    <Field id="name" name="name" type="text" placeholder="Parkir A UTY 1"
                        :rules="CreateParkingRequest.name" v-model="selectedAddress.name" class="w-full" />
                    <br>
                ...
                <label for="slug" v-if="selectedAddress.name">
                    ...
                    <Field id="slug" name="slug" type="text" placeholder="parkir-a-uty-1"
                        :rules="CreateParkingRequest.slug" v-model="selectedAddress.slug" class="w-full" />
                    <br>
